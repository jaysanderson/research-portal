  ...
  return (
    <div className={`flex items-center gap-2.5 ${className}`}>
      <svg viewBox="0 0 32 32" className="h-8 w-8 shrink-0" aria-hidden>
        ...
        <circle cx="14" cy="14" r="6.5" className="fill-none stroke-brand-200" strokeWidth="2.5" />
        <line x1="18.8" y1="18.8" x2="25" y2="25" className="stroke-brand-200" strokeWidth="2.5" strokeLinecap="round" />
